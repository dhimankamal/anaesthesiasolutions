        ...
        ?>
                    ...
                    <div class="container">
                        <div class="page-title-wrap text-center w-100">
                            <div class="page-title-inner d-inline-block">
                                <h1 class="mb-0">Recovered Stories</h1>
                                <ol class="breadcrumb mb-0 justify-content-center">
                                    <li class="breadcrumb-item"><a href="index.html" title="">Home</a></li>
                                    <li class="breadcrumb-item active">Recovered Stories</li>
                                </ol>
                            </div>
                        </div><!-- Page Title Wrap -->
                    </div>
            ...
            <section>
                <div class="w-100 pt-100 pb-110 position-relative">
                    <div class="container">
                        <div class="storie-wrap2 text-center position-relative w-100">
                            <div class="row justify-content-center mrg30">
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="storie-box brd-rd10 overflow-hidden position-relative w-100">
                                        <div class="storie-img position-relative overflow-hidden w-100">
                                            ...
                                            <span class="position-absolute z1 scndry-bg rounded-pill">Los Angeles CA</span>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="storie-box brd-rd10 overflow-hidden position-relative w-100">
                                        <div class="storie-img position-relative overflow-hidden w-100">
                                            ...
                                            <span class="position-absolute z1 scndry-bg rounded-pill">California</span>
                                        </div>
                                        <div class="storie-info bg-color6 w-100">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="storie-box brd-rd10 overflow-hidden position-relative w-100">
                                        <div class="storie-img position-relative overflow-hidden w-100">
                                            ...
                                            <span class="position-absolute z1 scndry-bg rounded-pill">Philadelphia</span>
                                        </div>
                                        <div class="storie-info bg-color6 w-100">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="storie-box brd-rd10 overflow-hidden position-relative w-100">
                                        <div class="storie-img position-relative overflow-hidden w-100">
                                            <a href="storie-detail.html" title=""><img class="img-fluid w-100" src="assets/images/resources/storie-img1-4.jpg" alt="Storie Image 4"></a>
                                            <span class="position-absolute z1 scndry-bg rounded-pill">Los Angeles CA</span>
                                        </div>
                                        <div class="storie-info bg-color6 w-100">
                                            <h3 class="mb-0"><a href="storie-detail.html" title="">Philimia Darwin</a></h3>
                                            <span class="d-block thm-clr">Psychodynamic Therapy</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="storie-box brd-rd10 overflow-hidden position-relative w-100">
                                        <div class="storie-img position-relative overflow-hidden w-100">
                                            <a href="storie-detail.html" title=""><img class="img-fluid w-100" src="assets/images/resources/storie-img1-5.jpg" alt="Storie Image 5"></a>
                                            <span class="position-absolute z1 scndry-bg rounded-pill">California</span>
                                        </div>
                                        <div class="storie-info bg-color6 w-100">
                                            <h3 class="mb-0"><a href="storie-detail.html" title="">Miranda Sulia</a></h3>
                                            <span class="d-block thm-clr">Couple Problem</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="storie-box brd-rd10 overflow-hidden position-relative w-100">
                                        <div class="storie-img position-relative overflow-hidden w-100">
                                            <a href="storie-detail.html" title=""><img class="img-fluid w-100" src="assets/images/resources/storie-img1-6.jpg" alt="Storie Image 6"></a>
                                            <span class="position-absolute z1 scndry-bg rounded-pill">Philadelphia</span>
                                        </div>
                                        <div class="storie-info bg-color6 w-100">
                                            <h3 class="mb-0"><a href="storie-detail.html" title="">Dikosta Kulia</a></h3>
                                            <span class="d-block thm-clr">Mental Health</span>
                                        </div>
                                    </div>
                                </div>
