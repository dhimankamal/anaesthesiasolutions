                            ...
                            <div class="row mrg10">
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            ...
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-1.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-2.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-3 order-lg-1">
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-3.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-6">
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-4.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-6 order-lg-1">
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-5.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-3 order-lg-1">
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-6.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-3 order-lg-1">
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-7.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                    <div class="gallery-box brd-rd10 position-relative overflow-hidden w-100">
                                        ...
                                        <div class="gallery-info position-absolute">
                                            <h3 class="mb-0">Steps to Overcoming Teenage Anger</h3>
                                            <a class="d-inline-block" href="assets/images/resources/gallery-img1-8.jpg" data-fancybox="gallery" title=""><i class="flaticon-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
