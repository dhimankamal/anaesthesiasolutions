                        ...
                        <div class="row mrg30">
                            <div class="col-md-12 col-sm-12 col-lg-8">
                                <div class="post-detail w-100">
                                    <div class="post-feat-img video-box brd-rd10 position-relative overflow-hidden w-100">
                                        <img class="img-fluid w-100" src="assets/images/resources/storie-detail-img.jpg" alt="Storie Detail Image">
                                        <a class="position-absolute" href="https://player.vimeo.com/video/25969077" data-fancybox title=""><i class="fas fa-play-circle"></i></a>
                                    </div>
                                    <h2 class="mb-0">Kate Morrison<span class="scndry-clr">Couple Problem</span></h2>
                                    <p class="mb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos <a href="javascript:void(0);" title="">dolores et quas</a> molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat <a href="javascript:void(0);" title="">facere possimus</a>, omnis voluptas assumenda est, omnis dolor repellendus. <a href="javascript:void(0);" title="">Temporibus</a> autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum <a href="javascript:void(0);" title="">rerum hic tenetur</a> a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur.</p>
                                    ...
                                    <img class="img-fluid brd-rd10 w-100" src="assets/images/resources/storie-detail-img2.jpg" alt="Storie Detail Image 2">
                                    ...
                                    <p class="mb-0">To take a trivial example, which of us ever undertakes laborious <a href="javascript:void(0);" title="">physical exercise</a>, except to obtain some advantage from it? But who has any right to find fault with a man who chooses to enjoy a pleasure that has no annoying consequences, or one who avoids a pain that produces no resultant pleasure?</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-4">
                                <aside class="sidebar w-100">
                                    <div class="widget-box v3 request-consult-wrap2 z1 brd-rd10 position-relative overflow-hidden blue-layer3 opc98 text-center w-100" style="background-image: url(assets/images/pattern-bg1.jpg)">
                                        ...
                                        <form class="w-100 d-inline-block">
                                            ...
                                            <div class="btn-box"><button class="thm-btn scndry-bg brd-rd5 position-relative overflow-hidden" type="submit">Next Step</button></div>
                                        </form>
                                    </div>
